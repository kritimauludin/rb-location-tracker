                                ...
                                <div class="col-lg-5">
                                    ...
                                    <div class="form-group mb-3">
                                        <input type="email" id="email" name="email"
                                            ...
                                            value="{{ old('email', $customer->email) }}" class="form-control @error('email') is-invalid @enderror" required>
                                        @error('email')
                                            <div class="invalid-feedback">{{ $message }}</div>
                                        @enderror
                                    </div>
                                        ...
                                        <div class="row mb-3">
                                            ...
                                            <div class="col-sm-9">
                                                <input type="date" id="expire_date" name="expire_date"
                                                    ...
                                                    class="form-control @error('expire_date') is-invalid @enderror" required>
                                                @error('expire_date')
                                                    <div class="invalid-feedback">{{ $message }}</div>
                                                @enderror
                                            </div>
