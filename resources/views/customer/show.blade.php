    ...
    <section class="section">
        <div class="row">
            <div class="col-lg-12">
                ...
                <div class="card">
                    <div class="card-body">
                        <h5 class="card-title">Lihat Data Pelanggan</h5>
                                ...
                                <div class="col-lg-5">
                                        ...
                                        <div class="col-lg-6">
                                            <div class="form-group mb-3">
                                                ...
                                                <input type="text" id="edition" name="edition"
                                                    ...
                                                    value="{{ old('edition', $customer->newspaper->edition) }}" class="form-control @error('edition') is-invalid @enderror" readonly readonly>
                                                @error('edition')
                                                    <div class="invalid-feedback">{{ $message }}</div>
                                                @enderror
                                            </div>
                                        ...
                                        <div class="col-lg-3">
                                            <div class="form-group mb-3">
                                                <input type="number" id="amount" name="amount"
                                                     placeholder="Jumlah"
                                                    value="{{ old('amount', $customer->amount) }}" class="form-control @error('amount') is-invalid @enderror" readonly>
                                                @error('amount')
                                                    <div class="invalid-feedback">{{ $message }}</div>
                                                @enderror
                                            </div>
                                    ...
                                    <div class="form-group mb-3">
                                        <input type="text" id="customer_name" name="customer_name"
                                            ...
                                            class="form-control  @error('customer_name') is-invalid @enderror" readonly>
                                        @error('customer_name')
                                            <div class="invalid-feedback">{{ $message }}</div>
                                        @enderror
                                    </div>
                                    <div class="form-group mb-3">
                                        <input type="email" id="email" name="email"
                                            ...
                                            value="{{ old('email', $customer->email) }}" class="form-control @error('email') is-invalid @enderror" readonly>
                                        @error('email')
                                            <div class="invalid-feedback">{{ $message }}</div>
                                        @enderror
                                    </div>
                                    <div class="form-group mb-3">
                                        <input type="number" id="phone_number" name="phone_number"
                                            ...
                                            value="{{ old('phone_number', $customer->phone_number) }}" class="form-control @error('phone_number') is-invalid @enderror"
                                            readonly>
                                        @error('phone_number')
                                            <div class="invalid-feedback">{{ $message }}</div>
                                        @enderror
                                        ...
                                        <div class="row mb-3">
                                            ...
                                            <div class="col-sm-9">
                                                <input type="date" id="join_date" name="join_date"
                                                    ...
                                                    class="form-control @error('join_date') is-invalid @enderror" readonly>
                                                @error('join_date')
                                                    <div class="invalid-feedback">{{ $message }}</div>
                                                @enderror
                                            </div>
                                        ...
                                        <div class="row mb-3">
                                            ...
                                            <div class="col-sm-9">
                                                <input type="date" id="expire_date" name="expire_date"
                                                    ...
                                                    class="form-control @error('expire_date') is-invalid @enderror" readonly>
                                                @error('expire_date')
                                                    <div class="invalid-feedback">{{ $message }}</div>
                                                @enderror
                                            </div>
