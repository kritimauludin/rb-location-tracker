                    ...
                    <div class="card-body">
                            ...
                            <div class="col-lg-2">
                                <div class="form-group mb-3">
                                    <input type="text" id="created_at" name="created_at"
                                       placeholder="Tgl distribusi" class="form-control  text-center" readonly>
                                </div>
                            </div>
                            <div class="col-lg-2">
                                <div class="form-group mb-3">
                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-2">
                                <div class="form-group mb-3">
                                    <input type="text" id="created_at" name="created_at"
                                        value="{{ $distribution->created_at }}" class="form-control  text-center" disabled>
                                </div>
                            </div>
                            <div class="col-lg-2">
                                <div class="form-group mb-3">
                        ...
                        <div class="row">
                            <div class="col-lg-2">
                                <div class="form-group mb-3">
                                    <input type="text" id="courier->user_code" name="courier->user_code"
                                        placeholder="Kode kurir" class="form-control text-center" readonly>
                                </div>
                            </div>
                            <div class="col-lg-4">
                                <div class="form-group mb-3">
                            ...
                            <div class="col-lg-2">
                                <div class="form-group mb-3">
                                    <input type="text" id="courier->user_code" name="courier->user_code"
                                        placeholder="No hp kurir " class="form-control text-center" readonly>
                                </div>
                            </div>
                            <div class="col-lg-4">
                                <div class="form-group mb-3">
                                    <input type="text" id="courier->user_code" name="courier->user_code"
                                        placeholder="Email kurir " class="form-control text-center" readonly>
                                </div>
                            </div>
                        </div>
                        <div class="row">
                                ...
                                <div class="col-lg-2">
                                    <div class="form-group mb-3">
                                        <input type="text" id="customer_code" name="customer_code"
                                            placeholder="Kode pelanggan" class="form-control text-center" readonly>
                                    </div>
                                </div>
                                <div class="col-lg-4">
                                    <div class="form-group mb-3">
                                        <input type="text" id="courier_name" name="courier_name"
                                            placeholder="Nama pelanggan" class="form-control text-center" readonly>
                                    </div>
                                </div>
                                <div class="col-lg-2">
                                    <div class="form-group mb-3">
                                        <input type="text" id="customer->user_code" name="customer->user_code"
                                            placeholder="No hp pelanggan" class="form-control text-center" readonly>
                                    </div>
                                </div>
                                <div class="col-lg-3">
                                    <div class="form-group mb-3">
                                        <input type="text" id="customer->email" name="customer->email"
                                            placeholder="Email pelanggan" class="form-control text-center" readonly>
                                    </div>
                                </div>
                                <div class="col-lg-1">
                                    <div class="form-group mb-3">
