                                ...
                                <div class="col-lg-2">
                                    <div class="form-group mb-3">
                                        <input type="text" id="created_at" name="created_at"
                                            value="{{ $distribution->created_at }}" class="form-control  text-center"
                                            disabled>
                                    </div>
                                </div>
                                <div class="col-lg-2">
                                    <div class="form-group mb-3">
                                        <input type="text" id="total_newspaper" name="total_newspaper"
                                            ...
                                            value="{{ $distribution->total_newspaper }}" class="form-control text-center"
                                            disabled>
                                    </div>
                                </div>
                            </div>
                                ...
                                <div class="col-lg-4">
                                    <div class="form-group mb-3">
                                        <input type="text" id="courier_name" name="courier_name"
                                            ...
                                            value="{{ $distribution->courier->name }}" class="form-control @error('courier_name') is-invalid @enderror text-center"
                                            disabled>
                                    </div>
                                </div>
                                <div class="col-lg-2">
                            ...
                            <div class="row">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-lg-4">
                                        <div class="form-group mb-3">
                                            <input type="text" id="courier_name" name="courier_name"
                                                placeholder="Nama pelanggan" class="form-control text-center"
                                                readonly>
                                        </div>
                                    </div>
                                    <div class="col-lg-2">
                                ...
                                @foreach ($distribution->user_distribution as $distribution)
                                    <div class="row">
                                        <div class="col-lg-2">
                                            <div class="form-group mb-3">
                                                <input type="text" id="customer_code" name="customer_code"
                                                    placeholder="Kode customer (auto)" value="{{ $distribution->customer_code }}"
                                                    class="form-control text-center" disabled>
                                            </div>
                                        </div>
                                        <div class="col-lg-4">
                                            <div class="form-group mb-3">
                                                <input type="text" id="courier_name" name="courier_name"
                                                    ...
                                                    value="{{ $distribution->customer->customer_name }}" class="form-control text-center"
                                                    disabled>
                                            </div>
                                        </div>
                                        <div class="col-lg-2">
                                            <div class="form-group mb-3">
                                                <input type="text" id="customer->user_code" name="customer->user_code"
                                                    placeholder="no hp kurir (auto)" value="{{ $distribution->customer->phone_number }}"
                                                    class="form-control text-center" disabled>
                                            </div>
                                        </div>
                                        <div class="col-lg-3">
                                            <div class="form-group mb-3">
                                                <input type="text" id="customer->email" name="customer->email"
                                                    placeholder="no hp kurir (auto)" value="{{ $distribution->customer->email }}"
                                                    class="form-control text-center" disabled>
                                            </div>
                                        </div>
                                        <div class="col-lg-1">
