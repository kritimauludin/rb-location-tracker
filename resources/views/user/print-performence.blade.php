            ...
            <?php for ($i = 0; $i < count($courierPerformence); $i++) : ?>
                <?php foreach ($courierPerformence[$i]['user_distribution'] as $distribution) : ?>
                    ...
                    <tr style="font-size: 12px;">
                        ...
                        <td style="font-size: 12px; text-align:center; paddding:5px"><?= date('d-m-Y', strtotime($distribution['created_at'])) ?></td>
                        ...
                        <?php else : ?>
                            <td style="font-size: 12px; text-align:center; paddding:5px">{{ date('H:i:s', strtotime($startTime)) }}</td>
                            <td style="font-size: 12px; text-align:center; paddding:5px">{{ date('H:i:s', strtotime($finishTime)) }}</td>
