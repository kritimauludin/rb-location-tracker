                    ...
                    <div class="card-body">
                        ...
                        <form action="/newspaper" method="POST" enctype="multipart/form-data">
                            ...
                            <div class="row">
                                <div class="col-lg-7">
                                    <div class="form-group mb-3">
                                        <textarea name="description" id="description" cols="100%" rows="10" class="form-control @error('newspaper_code') is-invalid @enderror"
                                        placeholder="Deskripsi Edisi" required>{{ old('newspaper_code') }}</textarea>
                                        @error('description')
                                            <div class="invalid-feedback">{{ $message }}</div>
                                        @enderror
                                    </div>
